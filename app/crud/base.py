...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    # Add the entity
    async def get_or_create(self, db: AsyncSession, defaults: Optional[Dict[str: Any]], **kwargs: Any):
    ...
    # Fully update and entity
    async def update(self, db: AsyncSession, *, obj_current: ModelType,
    ...
    async def remove(self, db: AsyncSession, *, obj_id: str):
